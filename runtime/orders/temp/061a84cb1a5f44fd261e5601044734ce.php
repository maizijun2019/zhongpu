<?php /*a:1:{s:57:"E:\Pro\pro\ZP\app\orders\view\process_review\process.html";i:1597311082;}*/ ?>
<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport"
  ...
  if ($('#agree').length > 0) {
    ...
    $('#agree').on('click', function () {
        ...
        data: {orders_id:orders_id, consultant:consultant},
