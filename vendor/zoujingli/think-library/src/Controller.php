...
abstract class Controller extends \stdClass
{
    ...
    {
        define("SERVER_NAME","http://{$_SERVER["HTTP_HOST"]}/");//本地
//        define("SERVER_NAME","http://{$_SERVER["HTTP_HOST"]}/zp/public/");//服务器
        define('MONEY_ACCURACY',2);//金额四舍五入精度
        define('DEFAULT_PAGE',1);//默认页数
        define('DEFAULT_SUM',10);//默认条数
        $this->app = $app;
